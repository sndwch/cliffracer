    ...
    def _register_handlers(self):
        ...
        async def create_order(saga_id: str, correlation_id: str, step: str, data: dict) -> dict:
            ...
            try:
                ...
                return {"result": {"order_id": created_order.order_id, "status": "created"}}
    ...
    def _register_handlers(self):
        ...
        async def process_payment(saga_id: str, correlation_id: str, step: str, data: dict) -> dict:
            ...
            try:
                ...
                return {"result": {"payment_id": created_payment.payment_id, "status": "completed"}}
            except Exception as e:
                return {"error": str(e)}
...
class InventoryService(CliffracerService, SagaParticipant):
    ...
    def _register_handlers(self):
        ...
        async def reserve_inventory(
            saga_id: str, correlation_id: str, step: str, data: dict
        ) -> dict:
            ...
            try:
                ...
                return {"result": {"reserved_items": reserved_items, "status": "reserved"}}
            except Exception as e:
                return {"error": str(e)}
...
class OrderChoreographyService(CliffracerService):
    ...
    def __init__(self):
        ...
        self.saga.on_event("payment.completed")(
            self.saga.emits("order.payment_confirmed", "order.payment_failed")(
    ...
    async def handle_shipment_created(self, data: dict) -> dict:
        ...
        if order:
            ...
            await self.publish(
                "order.completed",
                {"saga_id": data["saga_id"], "order_id": data["order_id"], "status": "completed"},
            )
