...
class ValidationMixin:
    ...
    async def _handle_rpc_request_with_validation(self, msg):
        ...
        if handler_name not in self._validated_rpc_handlers:
            ...
            return await super()._handle_rpc_request(msg)
        ...
        try:
            ...
            if inspect.iscoroutinefunction(handler):
                result = await handler(self, validated_data)
            else:
                result = handler(self, validated_data)
