...
class SimpleAuthService:
    ...
    def create_user(
        ...
        """Create a new user"""
        from ..core.validation import validate_username, validate_password, validate_string_length
...
def get_auth_service() -> Optional[SimpleAuthService]:
    """Get the global auth service"""
    return _auth_service


def get_current_context() -> Optional[AuthContext]:
