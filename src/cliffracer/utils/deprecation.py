...
from messaging import AWSClient, MessageClient, MessageClientFactory, NATSClient
from monitoring.clients import CloudWatchClient, MonitoringClient
from monitoring.metrics import ZabbixMetricsService
from nats_runner import ServiceOrchestrator, ServiceRunner

# Import new classes
from nats_service import BaseNATSService, NATSService, NATSServiceMeta
from nats_service_extended import (
    ConfigurableNATSService,
    HTTPNATSService,
    PluggableNATSService,
    SecureNATSService,
...
def _deprecated_service(*args, **kwargs):
    warnings.warn(
        "Service is deprecated. Use NATSService instead.", DeprecationWarning, stacklevel=2
    )
...
def _deprecated_awsmessagingclient(*args, **kwargs):
    warnings.warn(
        "AWSMessagingClient is deprecated. Use AWSClient instead.", DeprecationWarning, stacklevel=2
    )
...
def _deprecated_servicemeta(*args, **kwargs):
    warnings.warn(
        "ServiceMeta is deprecated. Use NATSServiceMeta instead.", DeprecationWarning, stacklevel=2
    )
