...
def refactor_file(
    file_path: Path, mappings: dict[str, str], dry_run: bool = True
) -> dict[str, int]:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Refactor class names in the microservices framework"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--create-aliases", action="store_true", help="Create backward compatibility file"
    )
    ...
    print("🚀 Starting class name refactoring...")
